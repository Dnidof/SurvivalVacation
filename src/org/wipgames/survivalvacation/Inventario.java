    ...
    public void barco() {
    	...
    	while (segundosRestantes>0) {
    		...
    		if(segundosRestantes == 0) {
    			System.out.println("Se te ha acabado el tiempo, el barco se ha hundido al igual que tus esperanzas de sobrevivir. Despues de 1 hora en el mar te parece ver algo a lo lejos, Estoy salvado! La marea parece llevarte a la isla que has visto y despues de un rato llegas alli para darte cuenta de que no parece haber ningun rastro de civilizacion humana. Enseguida te das cuenta de que tendras que sobrevivir hasta que alguien te rescate. Por suerte has conseguido recoger un kit de emergencia antes de saltar del barco que contenia: 1 lata de comida, 1 venda y 1botella de agua");
    			System.out.println();
    		}
    	}
